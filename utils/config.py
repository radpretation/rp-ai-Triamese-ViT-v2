...
parser.add_argument('--output_dir'     ,default= 'output_dir'              ,type=str, help="Output dictionary, whici will contains training log and model checkpoint")
parser.add_argument('--train_folder'   ,default='/home/omen/Documents/Rishabh/rp-ai-Brain-age-data-distribution/Balancedmeanandstd_dataset/NTrain'         ,type=str, help="Train set data path ")
parser.add_argument('--valid_folder'   ,default='/home/omen/Documents/Rishabh/rp-ai-Brain-age-data-distribution/Balancedmeanandstd_dataset/NVal'         ,type=str, help="Validation set data path ")
parser.add_argument('--test_folder'    ,default='/home/omen/Documents/Rishabh/rp-ai-Brain-age-data-distribution/Balancedmeanandstd_dataset/NTest'          ,type=str, help="Test set data path ")
parser.add_argument('--mask_folder'    ,default='/home/omen/Documents/Rishabh/rp-ai-Brain-age-data-distribution/Balancedmeanandstd_dataset/NTest'          ,type=str, help="Mask set data path ")

parser.add_argument('--excel_path'     ,default='/home/omen/Documents/Rishabh/rp-ai-Brain-age-data-distribution/Balancedmeanandstd_dataset/Combined.xlsx',type=str, help="Excel file path ")
...
parser.add_argument('--batch_size'  ,default=16           ,type=int,   help="Batch size during training process")
